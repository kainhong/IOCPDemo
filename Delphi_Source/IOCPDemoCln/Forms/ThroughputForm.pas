...
begin
  ...
  begin
    ...
    begin
      ...
      ListItem.SubItems.Add(FCyclePacketThreads[i].ThroughputSocket.Client.Socket.Binding.IP + ':'
        + IntToStr(FCyclePacketThreads[i].ThroughputSocket.Client.Socket.Binding.Port));
      ListItem.SubItems.Add(FCyclePacketThreads[i].ThroughputSocket.Client.Socket.Binding.PeerIP + ':'
        + IntToStr(FCyclePacketThreads[i].ThroughputSocket.Client.Socket.Binding.PeerPort));
